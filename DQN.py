...
class DQN_LateFusion(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        print("DQN Late fusion with Temporal Context")
...
class DQN_LateFusion_noTCtx(nn.Module):
    
    def __init__(self, input_size, output_size):
        super(DQN_LateFusion_noTCtx, self).__init__()
               
        print("DQN Late fusion without Temp Context")
        ...
        self.hidden1 = nn.Sequential(
            nn.Linear(self.embedding_size*5, 512),
            nn.BatchNorm1d(512),
            nn.ReLU()
        )
        self.hidden2 = nn.Sequential(
...
class DQN_LateFusion_noTCtx_noZ(nn.Module):
    
    def __init__(self, input_size, output_size):
        super(DQN_LateFusion_noTCtx, self).__init__()
               
        print("DQN Late fusion without Temp Context and Z")
        ...
        self.hidden1 = nn.Sequential(
            nn.Linear(self.embedding_size*4, 512),
            nn.BatchNorm1d(512),
            nn.ReLU()
        )
        self.hidden2 = nn.Sequential(
